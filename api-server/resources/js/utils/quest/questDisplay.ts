import type { QuestItem, QuestType } from '@/types/quest/quest';
...
} from '@/utils/quest-sheet/questSheetMeta';
import { formatExperiencePoints } from '@/utils/quest/questDifficulty';
import { formatSkillGrantReward } from '@/utils/quest/skillGrants';
...
export const formatQuestReward = (reward: { skill: string }): string =>
    formatSkillGrantReward(reward.skill as import('@/constants/shared/skills').SkillKey);
