...
import { selectMentorStudent } from '@/api/mentor';
import { mentorNotificationsPageConfig } from '@/constants/mentorNotifications';
...
import MentorNotificationTable from '@/components/rpg/MentorNotificationTable.vue';
