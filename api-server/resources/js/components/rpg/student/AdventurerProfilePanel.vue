...
import { skillDefinitions } from '@/constants/shared/skills';
import RpgCard from '@/components/rpg/shared/RpgCard.vue';
import RpgButton from '@/components/rpg/shared/RpgButton.vue';
import StudentBasicStatusCard from '@/components/rpg/student/StudentBasicStatusCard.vue';
import StatRow from '@/components/rpg/student/StatRow.vue';
import LevelPanel from '@/components/rpg/student/LevelPanel.vue';
// TODO: 後に機能追加 — 獲得バッジ数表示
// import BadgeCountPill from '@/components/rpg/badge/BadgeCountPill.vue';
import EquipmentSlot from '@/components/rpg/student/EquipmentSlot.vue';
