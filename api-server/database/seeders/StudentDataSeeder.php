...
class StudentDataSeeder extends Seeder
{
    ...
    private const STUDENT_PRESETS = [
        'student@prum.local' => [
            ...
            'stats' => [
                'stat_business_skill' => 3,
                'stat_human_skill' => 6,
                'stat_conceptual_skill' => 3,
            ],
        ],
        'hana@prum.local' => [
            ...
            'stats' => [
                'stat_business_skill' => 2,
                'stat_human_skill' => 8,
                'stat_conceptual_skill' => 2,
            ],
        ],
        'kenta@prum.local' => [
            ...
            'stats' => [
                'stat_business_skill' => 8,
                'stat_human_skill' => 3,
                'stat_conceptual_skill' => 5,
            ],
        ],
        'sora@prum.local' => [
